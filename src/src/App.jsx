...
function FeedbackCard() {
  return (
    <div style={{ background: "#fff", borderRadius: 16, padding: 28, border: "1px solid #E2E8F0", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
      ...
      <iframe
        src="https://tally.so/embed/44A24b?alignLeft=1&hideTitle=1&transparentBackground=1"
        width="100%"
        height="280"
        frameBorder="0"
        marginHeight="0"
...
function ContactCard() {
  return (
    <div style={{ background: "#fff", borderRadius: 16, padding: 28, border: "1px solid #E2E8F0", boxShadow: "0 2px 12px rgba(0,0,0,0.06)" }}>
      ...
      <iframe
        src="https://tally.so/embed/aQKB9E?alignLeft=1&hideTitle=1&transparentBackground=1"
        width="100%"
        height="380"
        frameBorder="0"
        marginHeight="0"
